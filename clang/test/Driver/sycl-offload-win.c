...
// FOFFLOAD_STATIC_LIB_SRC: 8: offload, "host-sycl (x86_64-pc-windows-msvc)" {4}, "device-sycl (spir64-unknown-unknown)" {7}, c++-cpp-output
...
// FOFFLOAD_STATIC_LIB_SRC: 23: offload, "host-sycl (x86_64-pc-windows-msvc)" {12}, "device-sycl (spir64-unknown-unknown)" {22}, image
