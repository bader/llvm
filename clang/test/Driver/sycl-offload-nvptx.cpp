...
// RUN: -fsycl-targets=nvptx64-nvidia-nvcl %s 2>&1 \
...
// CHK-PHASES-NO-CC: 7: offload, "host-sycl (x86_64-unknown-linux-gnu)" {3}, "device-sycl (nvptx64-nvidia-nvcl:sm_50)" {6}, c++-cpp-output
...
// CHK-PHASES-NO-CC: 16: offload, "host-sycl (x86_64-unknown-linux-gnu)" {11}, "device-sycl (nvptx64-nvidia-nvcl:sm_50)" {15}, image

/// Check phases specifying a compute capability.
// RUN: %clangxx -ccc-print-phases -std=c++11 -target x86_64-unknown-linux-gnu -fsycl -fsycl-use-footer \
// RUN: -fsycl-targets=nvptx64-nvidia-nvcl \
...
// CHK-PHASES: 7: offload, "host-sycl (x86_64-unknown-linux-gnu)" {3}, "device-sycl (nvptx64-nvidia-nvcl:sm_35)" {6}, c++-cpp-output
...
// CHK-PHASES: 16: offload, "host-sycl (x86_64-unknown-linux-gnu)" {11}, "device-sycl (nvptx64-nvidia-nvcl:sm_35)" {15}, image
